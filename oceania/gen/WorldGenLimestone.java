...
public class WorldGenLimestone implements IWorldGenerator
{
	...
	public WorldGenLimestone(int veinSize, int veinsPerChunk)
	{
	...
	public void generate(Random random, int chunkX, int chunkZ, World world, IChunkProvider chunkGenerator, IChunkProvider chunkProvider)
	{
		if (world.provider.dimensionId == 0 /** Surface world */)
		{
			...
			if (world.getBiomeGenForCoords(chunkBlockX, chunkBlockZ) == BiomeGenBase.ocean || world.getBiomeGenForCoords(chunkBlockX, chunkBlockZ) == BiomeGenBase.river) // Generate in the ocean
			{
	...
	{
		WorldGenMinable gen = new WorldGenMinable(Blocks.blockLimestone.blockID, BlockLimestone.LimestoneTypes.LIMESTONE.ordinal(), this._veinSize, Block.sand.blockID);
